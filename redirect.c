...
{
  if (argc != 8) {
        printf("Usage: ./get src_ip dst_ip seq ack src_port dst_port www.taobao.com\n");
        return;
  }
  ...
  char* response1 = "HTTP/1.1 302 Moved Temporarily\r\nServer: nginx/1.4.4\r\nDate: Sat, 30 May 2015 12:26:25 GMT\r\nContent-Type: text/html\r\nTransfer-Encoding: chunked\r\nConnection: keep-alive\r\nX-Powered-By: PHP/5.5.7\r\nLocation: ";
  char* response2 = "http://www.taobao.com";
  char* response3 = "\r\n\r\n";

  strcpy(payload, str_contact(str_contact(response1, argv[7]), response3));
